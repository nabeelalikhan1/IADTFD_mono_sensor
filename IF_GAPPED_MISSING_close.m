    ...
    for N_S=4:4:16
        ...
        for k1=1:NS
            ...
            for kkkkk=0:1
                ...
                [fmult]= merge_IFs(fmult,orient,10,10,length(Sig)/2);
...
figure;
plot(8:4:20,mse_IADTFD(2,:),'k','linewidth',3);
hold on;
plot(8:4:20,mse_ADTFD(2,:),'r','linewidth',3);
xlabel('Number of missing samples in each gap')
ylabel('Mean absolute errror')
title('b')
legend('IADTFD','ADTFD');
...
figure;
plot(8:4:20,mse_IADTFD(3,:),'k','linewidth',3);
hold on;
plot(8:4:20,mse_ADTFD(3,:),'r','linewidth',3);
xlabel('Number of missing samples in each gap')
ylabel('Mean absolute errror')
title('c')
legend('IADTFD','ADTFD');
...
figure;
plot(8:4:20,mse_IADTFD(4,:),'k','linewidth',3);
hold on;
plot(8:4:20,mse_ADTFD(4,:),'r','linewidth',3);
xlabel('Number of missing samples in each gap')
ylabel('Mean absolute errror')
title('d')
legend('IADTFD','ADTFD');
